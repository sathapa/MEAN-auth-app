...
const appRoutes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
...
let LoginComponent = class LoginComponent {
    ...
    onLoginSubmit() {
        ...
        this.authService.authenticateUser(user).subscribe({
            next: data => {
                this.data = data;
                this.storeLoginData(this.data);
            }, error: err => {
                this.flashMessage.show('Error: ' + err, { cssClass: 'alert-danger', timeout: 3000 });
    ...
    storeLoginData(data) {
        if (data.success) {
            ...
            this.flashMessage.show('You\'re now logged in.', { cssClass: 'alert-success', timeout: 3000 });
...
let RegisterComponent = class RegisterComponent {
    constructor(validateService, flashMessage, authService, routerService) {
    ...
    onRegisterSubmit() {
        ...
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('Please validate email.', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        // Register User
        this.authService.registerUser(user).subscribe({
            next: data => {
                this.flashMessage.show('You\'re now registered and can now login.', { cssClass: 'alert-success', timeout: 3000 });
...
module.exports = __webpack_require__(/*! c:\meanapp\angular-src\src\main.ts */"./src/main.ts");
