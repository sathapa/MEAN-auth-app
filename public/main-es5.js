...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsHomeHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"container\">\n    <div class=\"jumbotron text-center\">\n        <h1 class=\"display-4\">MEAN App</h1>\n        <p class=\"lead\">MEAN stack Authentication application using Angular, NodeJS, Express and MongoDB.</p>\n        \n        \n        <a class=\"btn btn-primary\" [routerLink]=\"['/login']\" role=\"button mx-2\">Login</a>\n        <a class=\"btn btn-dark\" [routerLink]=\"['/register']\" role=\"button\">Register</a>\n        \n    </div>\n\n    <div class=\"row\">\n        <div class=\"col-md-4\">\n            <h3>Express Backend</h3>\n            <p>Express (nodeJS)</p>\n        </div>\n        <div class=\"col-md-4\">\n            <h3>Angular-CLI</h3>\n            <p>Angular JS framework</p>\n        </div>\n        <div class=\"col-md-4\">\n            <h3>JWT TOken</h3>\n            <p>NPM JWT token package</p>\n        </div>\n    </div>\n</div>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var angular2_flash_messages__WEBPACK_IMPORTED_MODULE_15___default =
    /*#__PURE__*/
    __webpack_require__.n(angular2_flash_messages__WEBPACK_IMPORTED_MODULE_15__);
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_6__["NavbarComponent"], _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["DashboardComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], _components_register_register_component__WEBPACK_IMPORTED_MODULE_9__["RegisterComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"], _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_11__["ProfileComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_12__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(appRoutes), _angular_forms__WEBPACK_IMPORTED_MODULE_13__["FormsModule"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_15__["FlashMessagesModule"].forRoot()],
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onLoginSubmit() {
          ...
          this.authService.authenticateUser(user).subscribe({
            next: function next(data) {
              ...
              _this.storeLoginData(_this.data);
            },
            error: function error(err) {
              _this.flashMessage.show('Error: ' + err, {
        ...
        key: "storeLoginData",
        value: function storeLoginData(data) {
          if (data.success) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getProfile().subscribe({
            next: function next(profile) {
              _this2.user = profile;
              _this2.user = _this2.user.user;
            },
            error: function error(err) {
              console.log(err);
              return false; // this.flashMessage.show( 'Error: '+err, {cssClass: 'alert-danger', timeout: 3000});
              // this.router.navigate(['login']); 
            }
          });
        }
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function RegisterComponent(validateService, flashMessage, authService, routerService) {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onRegisterSubmit() {
          ...
          this.authService.registerUser(user).subscribe({
            next: function next(data) {
              _this3.flashMessage.show('You\'re now registered and can now login.', {
                cssClass: 'alert-success',
                timeout: 3000
              });
            ...
            error: function error(err) {
              _this3.flashMessage.show('Error: ' + err, {
                cssClass: 'alert-danger',
                timeout: 3000
              });

              _this3.routerService.navigate(['/register']);
            }
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! c:\meanapp\angular-src\src\main.ts */
    "./src/main.ts");
    /***/
  }
